<template>
  <section class="terms_of_service l-terms_of_service">
    <div class="terms_of_service__block">
      <div class="inner">
        <h2 class="terms_of_service__title">- 利用規約 -</h2>
        <p>
          この利用規約(以下、「本規約」といいます。)は、本サービス(本サイトを含むものとし、以下、特に両者を区別しません。)の利用条件を定めるものです。本規約は、本サービスを利用するすべてのユーザーに適用されます。
        </p>
        <h3 class="terms_of_service__heading">本規約への同意</h3>
        <p>
          ユーザーは、本サービスを利用することによって、本規約に有効かつ取り消し不能な同意をしたものとみなされます。本規約に同意しないユーザーは、本サービスをご利用いただけません。
        </p>
        <h3 class="terms_of_service__heading">利用登録</h3>
        <p>
          本サービスの利用を希望する方は、本規約に同意の上、当社の定める方法によって利用登録を申請し、当社がこれを承認することによって、本サービスの利用登録をすることができます。
        </p>

        <h3 class="terms_of_service__heading">登録拒否</h3>
        <p>
          当社は、以下のいずれかの事由があると判断した場合、利用登録の申請を承認しないことがあります。当社は登録拒否の理由について一切の開示義務を負いません。
        </p>
        <ul class="terms_of_service__desc-list">
          <li>虚偽の事項を届け出た場合</li>
          <li>本規約に違反したことがある者からの申請である場合</li>
          <li>その他、当社が利用登録を相当でないと判断した場合</li>
          <li>その他、法律によって合法的に第三者提供が許されている場合</li>
        </ul>
        <h3 class="terms_of_service__heading">未成年による利用</h3>
        <p>
          ユーザーが未成年である場合には、法定代理人の同意を得た上で、本サービスを利用してください。本サービスのご利用にあたり必要となるスマートフォンその他デバイスについても、必ず法定代理人の同意を得た上でご使用下さい。<br />
          法定代理人の同意を得ずに本サービスのご利用を開始したユーザーが成年に達した場合、未成年者であった間の利用行為を追認したものとみなします。
        </p>

        <h3 class="terms_of_service__heading">ログイン情報の管理</h3>
        <p>
        ...
        <h3 class="terms_of_service__heading">コンテンツのご利用</h3>
        <p>
        ...
        <h3 class="terms_of_service__heading">禁止事項</h3>
        <p>
        ...
        <h3 class="terms_of_service__heading">利用制限</h3>
        <p>
        ...
        <h3 class="terms_of_service__heading">本サービスの提供の停止</h3>
        <p>
        ...
        <h3 class="terms_of_service__heading">サービス内容の変更</h3>
        <p>
        ...
        <h3 class="terms_of_service__heading">利用規約の変更</h3>
        <p>
        ...
        <h3 class="terms_of_service__heading">個人情報の取扱い</h3>
        <p>
          本サービスの利用によって取得するユーザーの個人情報については、当社のプライバシーポリシーに従い適切に取り扱うものとします。
        </p>
        <h3 class="terms_of_service__heading">通知または連絡</h3>
        <p>
          ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
        </p>
        <h3 class="terms_of_service__heading">権利義務の譲渡</h3>
        <p>
          ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
        </p>
        <h3 class="terms_of_service__heading">事業譲渡</h3>
        <p>
        ...
        <h3 class="terms_of_service__heading">適用関係</h3>
        <p>
