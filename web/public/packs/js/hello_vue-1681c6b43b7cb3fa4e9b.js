...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  actions: {
    ...
    updateSubordinate: function updateSubordinate(_ref3, subordinate) {
      var commit = _ref3.commit;
      return _plugins_axios__WEBPACK_IMPORTED_MODULE_2__["default"].patch("subordinates/".concat(subordinate.id), subordinate).then(function (res) {
        commit("updateSubordinate", res.data);
      });
    }
  }
}));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this2.updateSubordinate(subordinate);
              case 3:
                _this2.handleCloseSubordinateEditModal();
                _context.next = 9;
                break;
              case 6:
                _context.prev = 6;
...
/******/ });
//# sourceMappingURL=hello_vue-1681c6b43b7cb3fa4e9b.js.map