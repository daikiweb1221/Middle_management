...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(["subordinates"])), {}, {
    SubordinateData: function SubordinateData() {
      // const subordinate_id = parseInt(this.$route.params.id, 10);
      // console.log(subordinate_id);
      // const subordinate = subordinates.find(data => (
      //   data.id === subordinate_id
      // ));
      return console.log("subordinates");
    }
  }),
...
/******/ });
//# sourceMappingURL=hello_vue-fd52f5dbe6a0109b14e8.js.map