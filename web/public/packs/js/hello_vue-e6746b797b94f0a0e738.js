...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  actions: {
    ...
    showSubordinate: function showSubordinate(_ref3) {
      var commit = _ref3.commit;
      // const id = parseInt(this.$route.params.id, 10);
      var id = this.$route.params['id'];
      _plugins_axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("subordinates/" + id).then(function (res) {
...
/******/ });
//# sourceMappingURL=hello_vue-e6746b797b94f0a0e738.js.map