...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    ...
    detailSubordinate: function detailSubordinate(state, subordinate) {
      var id = parseInt(_this.$route.params.id, 10);
      var data = _this.subordinates;
      var targetData = data.find(function (target) {
        target.id === id;
        state.subordinate = targetData;
      });
    }
  },
  actions: {
...
var render = function render() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("p", [_vm._v(_vm._s(_vm.subordinate))]),
  ])
}
var staticRenderFns = []
render._withStripped = true
...
/******/ });
//# sourceMappingURL=hello_vue-9266a96b660b47560f6f.js.map