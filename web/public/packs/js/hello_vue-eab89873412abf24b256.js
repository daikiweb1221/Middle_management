...
var actions = {
  ...
  } // createEverydayBehavior({ commit }, everyday_behavior) {
  //   return axios.post("everyday_behaviors", everyday_behavior).then((res) => {
  //     commit("addEverydayBehavior", res.data);
  //   });
  // },
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])("users", ["authUser"])),
  methods: {
    // ...mapActions("everyday_behaviors", ["createEverydayBehavior"]),
    // handleCloseModal() {
    //   this.$emit("close-modal");
    // },
    // handleCreateEverydayBehavior() {
    //   this.$emit("create-everyday_behavior", this.everyday_behavior);
    // },
...
var render = function render() {
  ...
  return _c(
    "div",
    { attrs: { id: "subordinate-create-modal" } },
    [
      _c("ValidationObserver", {
        scopedSlots: _vm._u([
          {
...
/******/ });
//# sourceMappingURL=hello_vue-eab89873412abf24b256.js.map