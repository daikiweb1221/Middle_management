...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(["subordinates"])), {}, {
    subordinates: console.log(subordinates),
    SubordinateData: function SubordinateData() {
      var subordinate_id = parseInt(this.$route.params.id, 10);
      var subordinate = subordinates.find(function (a) {
        return a.id === subordinate_id;
      });
      return subordinate;
    }
  }),
...
/******/ });
//# sourceMappingURL=hello_vue-6e0d701fd546a31530d7.js.map