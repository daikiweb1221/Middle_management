...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(["subordinates"])), Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])("users", ["authUser"])), {}, {
    isAuthUserSubordinate: function isAuthUserSubordinate() {
      var _this = this;
      return this.subordinates.forEach(function (element) {
        // element.user_id === this.authUser.id;
        console.log(element.user_id === _this.authUser.id);
      });
    }
  }),
  created: function created() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this2.createSubordinate(subordinate);
              case 3:
                _this2.handleCloseSubordinateCreateModal();
                _context.next = 9;
                break;
              case 6:
                _context.prev = 6;
...
var render = function render() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "h3 mb-3" }, [_vm._v("\n    ログイン\n  ")]),
      _vm._v(" "),
    ...
    [
      ...
      _c("div", { staticClass: "form-group text-left" }, [
        ...
        _c("input", {
          ...
          staticClass: "form-control",
          attrs: { id: "name", type: "text", placeholder: "username" },
...
var render = function render() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("div", [_vm._v(_vm._s(_vm.isAuthUserSubordinate))]),
      _vm._v(" "),
      _c(
        "transition",
        { attrs: { name: "fade" } },
...
/******/ });
//# sourceMappingURL=hello_vue-e87ee548e833dd2622a8.js.map