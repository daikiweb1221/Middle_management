...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, "\n.edit-form[data-v-634f8947] {\n  margin-top: 30px;\n}\n", "",{"version":3,"sources":["/app/app/javascript/pages/everyday_behaviors/app/javascript/pages/everyday_behaviors/index.vue"],"names":[],"mappings":";AA4EA;EACA,gBAAA;AACA","file":"index.vue","sourcesContent":["<template>\n  <div>\n    <h1>日々の立ち振る舞い</h1>\n    <div>{{ authUser.name }}さんこんにちは</div>\n    <div>{{ everyday_behaviors.behaviors_one }}</div>\n    <div>{{ everyday_behaviors.behaviors_two }}</div>\n    <div>{{ everyday_behaviors.behaviors_three }}</div>\n    <div>{{ everyday_behaviors.behaviors_four }}</div>\n    <div>{{ everyday_behaviors.behaviors_five }}</div>\n    <div class=\"edit-form\">\n      <EverydayBehaviorEdit\n        :everyday_behavior=\"everyday_behaviorEdit\"\n        @update-everyday_behavior=\"handleUpdateEverydayBehavior\"\n      />\n    </div>\n  </div>\n</template>\n\n<script>\nimport { mapGetters, mapActions } from \"vuex\";\nimport EverydayBehaviorEdit from \"../components/EverydayBehaviorEdit\";\n\nexport default {\n  name: \"EverydayBehaviorIndex\",\n\n  data() {\n    return {\n      everyday_behaviorEdit = Object.assign({}, this.everyday_behaviors),\n    };\n  },\n\n  components: {\n    EverydayBehaviorEdit,\n  },\n\n  computed: {\n    ...mapGetters(\"everyday_behaviors\", [\"everyday_behaviors\"]),\n    ...mapGetters(\"users\", [\"authUser\"]),\n  },\n\n  created() {\n    this.fetchEverydayBehaviors();\n  },\n\n  methods: {\n    ...mapActions(\"everyday_behaviors\", [\"fetchEverydayBehaviors\"]),\n    updateEverydayBehavior(everyday_behavior) {\n      const target_everyday_behavior = this.everyday_behaviors.id;\n      this.$axios\n        .patch(\n          \"everyday_behaviors/\" + target_everyday_behavior,\n          everyday_behavior\n        )\n        .then((res) => {\n          this.$store.commit(\n            \"everyday_behaviors/updateEverydayBehavior\",\n            res.data\n          );\n          this.$router.go({\n            path: this.$router.currentRoute.path,\n            force: true,\n          });\n        });\n    },\n    async handleUpdateEverydayBehavior(everyday_behavior) {\n      try {\n        await this.updateEverydayBehavior(everyday_behavior);\n      } catch (error) {\n        console.log(error);\n      }\n    },\n  },\n};\n</script>\n\n<style scoped>\n.edit-form {\n  margin-top: 30px;\n}\n</style>\n"]}]);
// Exports
module.exports = exports;
...
/******/ });
//# sourceMappingURL=hello_vue-3fb1730a44b55f026411.js.map